...
2. Paste the **User prompt** verbatim as the first message — no extra context.
3. Reply to each turn following the **Expected user reply** column. If the skill asks something unexpected, just answer it but log the deviation.
4. After Turn 3, fill out `observation-log.md` for that run.
